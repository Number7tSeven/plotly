...
fn shapes() {
    ...
    let shape2 = Shape::new()
                 ...
                 .line(Line::new().color(NamedColor::LightBlue));
    ...
    let shape4 = Shape::new()
                 ...
                 .y1(14.0)
                 .line(Line::new()
                       .color(NamedColor::DarkOrange)
                       .width(4)
                       .dash("dot".to_string())
                 );

    let layout = Layout::new().shapes(vec![shape1, shape2, shape3, shape4]);
...
```
![plot_with_shapes](docs/images/shapes.png)

for more examples see [shapes.rs](plotly/examples/shapes.rs).
